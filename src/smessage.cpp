// Copyright (c) 2014 The OrbitalCoin developers
...
void ThreadSecureMsg(void* parg)
{
    ...
    RenameThread("orbitalcoin-smsg"); // Make this thread recognisable
...
void ThreadSecureMsgPow(void* parg)
{
    ...
    RenameThread("orbitalcoin-smsg-pow"); // Make this thread recognisable
